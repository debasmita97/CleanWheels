...
public class Complete360 extends AppCompatActivity {

    private DatePickerDialog.OnDateSetListener mDateSetListener;
    private static final String TAG = "Complete360";

    DatabaseHelper  mDatabaseHelper = new DatabaseHelper(this);

    Button buttonComplete360;
    Button buttonqrCode;
    TextView displayDateC360;
    EditText phone;
    EditText address;
    CheckBox carPickUp;
    String pickUpCar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete360);

        buttonqrCode =findViewById(R.id.qrCode);
        carPickUp = findViewById(R.id.carPickup);
        amountC360 = findViewById(R.id.amountC360);
        phone = findViewById(R.id.phone);
        displayDateC360= findViewById(R.id.dateC360);
        address = findViewById(R.id.address);

        displayDateC360.addTextChangedListener(bookingTextWatcher);
        phone.addTextChangedListener(bookingTextWatcher);
        address.addTextChangedListener(bookingTextWatcher);

        final String payableAmount = "₹ 1399";
        final String payableWithCarPickUp = "₹ 1599";
        ...
        amountC360.setText(payableAmount);

        carPickUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (carPickUp.isChecked()) {
                    amountC360.setText(payableWithCarPickUp);
                } else
                    amountC360.setText(payableAmount);
            }
        });
        ...
        displayDateC360.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
*/
        ...
        buttonComplete360 = findViewById(R.id.buttonComplete360);

        buttonComplete360.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                bookingDate = displayDateC360.getText().toString();
                phoneNumber = phone.getText().toString();
                pickUpAddress = address.getText().toString();
                amountToPay = amountC360.getText().toString();
        ...
        sentPI = PendingIntent.getBroadcast(Complete360.this, 0, new Intent(SENT), 0);
        deliveredPI = PendingIntent.getBroadcast(Complete360.this, 0, new Intent(DELIVERED), 0);
       ...
       /* buttonComplete360.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message = "Booking Confirmed for Complete 360!\nBooking Date" + bookingDate + "\nPayable Amount" + amountToPay + "\nThank You";

                if (ContextCompat.checkSelfPermission(Complete360.this, Manifest.permission.SEND_SMS)
                        != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Complete360.this, new String[]{Manifest.permission.SEND_SMS},
    ...
    private TextWatcher bookingTextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            //displayDateC360 = findViewById(R.id.dateCombo);
            phone = findViewById(R.id.phone);
            String bookingDate = displayDateC360.getText().toString().trim();
            String phoneNumber = phone.getText().toString().trim();
            String addressPickUp = address.getText().toString().trim();

            buttonComplete360.setEnabled(!bookingDate.isEmpty() && !phoneNumber.isEmpty() && !addressPickUp.isEmpty());
